...
This repository contains the implementation for the paper: **[Flow as Equilibrium: A Potential-Based Distributed Computing Framework for Multicommodity Flow]**.
...
1.  **Clone the repository:**
    ```bash
    git clone https://github.com/mrgump-123/Flow_as_Equilibrium.git
